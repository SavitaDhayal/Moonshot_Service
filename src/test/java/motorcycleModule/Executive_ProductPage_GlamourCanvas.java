...
public class Executive_ProductPage_GlamourCanvas extends base_class {
	...
	@Test()
	public void Executive_productPage_GlamourCanvas() throws Exception {
		...
		Custom_click(exe.GlamourCanvasText() , " on Glamour Canvas text ");
		Thread.sleep(2000);
		PageLoaded();
	...
	@Test(priority=5, dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_077_GlamourCanvas_Features() throws Exception {
	...
	@Test(priority=1,dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_078_GlamourCanvas_Specification() throws Exception {  
	...
	//	Custom_click(exe.Exe_Engine(), " On Engine text");
		...
		Wait(exe.Exe_glamourCan_Engine_Image());
		VerifyImagePresent(exe.Exe_glamourCan_Engine_Image(), " Engine Image of Glamour Canvas");
		
		Wait(exe.Exe_WheelsTyres());
		VerifyElementPresent(exe.Exe_WheelsTyres(), " ");
		Custom_click(exe.Exe_WheelsTyres(), " On Wheels & Tyres text");
		Thread.sleep(1000);
		Wait(exe.Exe_glamourCan_WheelsTyres_Image());
		VerifyImagePresent(exe.Exe_glamourCan_WheelsTyres_Image(), " WheelsTyres Image- Glamour Canvas");
		
		Wait(exe.Exe_Suspensions());
		VerifyElementPresent(exe.Exe_Suspensions(), " ");
		Custom_click(exe.Exe_Suspensions(), " On Susupensions text");
		Thread.sleep(1000);
		Wait(exe.Exe_glamourCan_Suspension_Image());
		VerifyImagePresent(exe.Exe_glamourCan_Suspension_Image(), " Susupension Image- Glamour Canvas");
		
		Thread.sleep(1000);
		Wait(exe.Exe_Chassis());
		VerifyElementPresent(exe.Exe_Chassis(), " ");
		Custom_click(exe.Exe_Chassis(), " On Chassis text");
		Wait(exe.Exe_glamourCan_Chassis_Image());
		VerifyImagePresent(exe.Exe_glamourCan_Chassis_Image(), " Chassis Image- Glamour Canvas");
		
		Thread.sleep(2000);
		Wait(exe.Exe_Brakes());
		VerifyElementPresent(exe.Exe_Brakes(), " ");
		Custom_click(exe.Exe_Brakes(), " On Brakes text");
		Wait(exe.Exe_glamourCan_Brakes_Image());
		VerifyImagePresent(exe.Exe_glamourCan_Brakes_Image(), " Brakes Image- Glamour Canvas");
		...
		Wait(exe.Exe_glamourCan_Dimensions_Image());
		VerifyImagePresent(exe.Exe_glamourCan_Dimensions_Image(), " Dimensions Image- Glamour Canvas");
	...
	@Test(priority=2,dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_079_GlamourCanvas_Price() throws Exception {     //44 steps
		...
		Wait(exe.Exe_Price_GlamourCanvas_Image());
        VerifyImagePresent(exe.Exe_Price_GlamourCanvas_Image(), " Bike Image of Glamour Canvas");
		Thread.sleep(2000);
...
//		ob.check_Variant_and_priceText();
	...
	@Test(priority=3, dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_080_GlamourCanvas_Compare() throws Exception {   
		...
		Wait(exe.Exe_Compare_glamourCanvas_Bike1_Img());  
		VerifyImagePresent(exe.Exe_Compare_glamourCanvas_Bike1_Img(), " image of first bike ");
		VerifyImagePresent(exe.Exe_Compare_glamourCanvas_Bike2_Img(), " image of second bike ");
		ob.Compare2Bikes();
	...
	@Test(priority=4, dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_081_GlamourCanvas_Find_A_Dealer() throws Exception{  
	...
	@Test(priority=0, dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void  TC_082_GlamourCanvas_RequestCallback() throws Exception {   
	...
	@Test(priority=6, dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_083_GlamourCanvas_Colours_360View() throws Exception {   // 44
		
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);",exe.colorSwitch_GlamourCanvas_CanvasBlack());
		...
		Wait(exe.colorSwitch_GlamourCanvas_CanvasBlack());
		VerifyImagePresent(exe.colorSwitch_GlamourCanvas_CanvasBlack(), "Canvas-Black Switch");
		Custom_click(exe.colorSwitch_GlamourCanvas_CanvasBlack(),"Canvas-Black Switch clickable");

		
		Wait(exe.colorSwitch_GlamourCanvas_RadiantRed());
		VerifyImagePresent(exe.colorSwitch_GlamourCanvas_RadiantRed(), "Radiant Red Switch");
		Custom_click(exe.colorSwitch_GlamourCanvas_RadiantRed(),"Radiant Red Switch clickable");
	
		
		Wait(exe.colorSwitch_GlamourCanvas_TechnoBlue());
		VerifyImagePresent(exe.colorSwitch_GlamourCanvas_TechnoBlue(), "Techno Blue Switch");
		Custom_click(exe.colorSwitch_GlamourCanvas_TechnoBlue(),"Techno Blue Switch clickable");
		
		Wait(exe.colorSwitch_GlamourCanvas_SunsetGold());
		VerifyImagePresent(exe.colorSwitch_GlamourCanvas_SunsetGold(), "Sunset Gold Switch");
		Custom_click(exe.colorSwitch_GlamourCanvas_SunsetGold(),"Sunset Gold Switch clickable");
		
		
		Wait(exe.colorSwitch_GlamourCanvas_FieryRed());
		VerifyImagePresent(exe.colorSwitch_GlamourCanvas_FieryRed(), "Fiery Red Switch");
		Custom_click(exe.colorSwitch_GlamourCanvas_FieryRed(),"Fiery Red Switch clickable");
		
		
		Wait(exe.colorSwitch_GlamourCanvas_DaringYellow());
		VerifyImagePresent(exe.colorSwitch_GlamourCanvas_DaringYellow(), "Canvas-Black Switch");
		Custom_click(exe.colorSwitch_GlamourCanvas_DaringYellow(),"Canvas-Black Switch clickable");
	...
	@Test(priority=7, dependsOnMethods = "Executive_productPage_GlamourCanvas")
	public void TC_084_EXE_GlamourCanvas_Book_A_Test_Ride() throws Exception {  
...
//	Custom_click(home.click_RequestCB_closeBttn1(),"close bttn clickable");
	...
	@Test(priority=8, dependsOnMethods = "Executive_productPage_GlamourCanvas")  //>>>need to check Explore now button if or not present
	public void TC_085_EXE_GlamourCanvas_EshopLinks() throws Exception {  
