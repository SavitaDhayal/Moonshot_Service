...
public class Executive_ProductPage_GlamourXtec extends base_class {
	...
	@Test(priority=5, dependsOnMethods = "Executive_productPage")
...
//		VerifyImagePresent(exe.Exe_HotSpot_Icon1(), " Image of Headlight");
	...
	@Test(priority=1, dependsOnMethods = "Executive_productPage")
	...
	@Test(priority=2, dependsOnMethods = "Executive_productPage")
...
//		ob.check_Variant_and_priceText();
	...
	@Test(priority=3, dependsOnMethods = "Executive_productPage")
...
//	ob.Compare2Bikes();
	...
	@Test(priority=4, dependsOnMethods = "Executive_productPage")
	...
	@Test(priority=0, dependsOnMethods = "Executive_productPage")
	...
	@Test(priority=6, dependsOnMethods = "Executive_productPage")
	...
	@Test(priority=7, dependsOnMethods = "Executive_productPage")
...
//	Custom_click(home.click_RequestCB_closeBttn1(),"close bttn clickable");
	...
	@Test(priority=8, dependsOnMethods = "Executive_productPage")   
