...
public class Executive_ProductPage_Glamour extends base_class {
	...
	@Test(priority=0)
	public void Executive_productPage_Glamour() throws Exception {
	...
	//	Thread.sleep(2000);
		...
		Custom_click(exe.GlamourText() , " on Glamour Text ");
		Thread.sleep(2000);
		PageLoaded();
	//	home.ReqCallBack();
...
//	@Test(priority=6)
	public void TC_095_Glamour_Features() throws Exception {
	...
	@Test(priority=2)
	public void TC_096_Glamour_Specification() throws Exception {  
	...
	//	Custom_click(exe.Exe_Engine(), " On Engine text");
		...
		Wait(exe.Exe_Glamour_Engine_Image());
		VerifyImagePresent(exe.Exe_Glamour_Engine_Image(), " Engine Image of Glmaour");
		...
		Thread.sleep(1000);
		Wait(exe.Exe_glamour_WheelsTyres_Image());
		VerifyImagePresent(exe.Exe_glamour_WheelsTyres_Image(), " Tyres Image- Glamour");
		...
		Thread.sleep(1000);
		Wait(exe.Exe_Glamour_Suspension_Image());
		VerifyImagePresent(exe.Exe_Glamour_Suspension_Image(), " Susupension Image-Glamour");
		...
		Wait(exe.Exe_Glamour_Chassis_Image());
		VerifyImagePresent(exe.Exe_Glamour_Chassis_Image(), " Chassis Image- Glamour");
		
		Thread.sleep(2000);
		Wait(exe.Exe_Brakes());
		VerifyElementPresent(exe.Exe_Brakes(), " ");
		Custom_click(exe.Exe_Brakes(), " On Brakes text");
		Wait(exe.Exe_Glamour_Brakes_Image());
		VerifyImagePresent(exe.Exe_Glamour_Brakes_Image(), " Brakes Image-Glamour");

		Thread.sleep(1000);
		Wait(exe.Exe_Dimensions());
		VerifyElementPresent(exe.Exe_Dimensions(), " ");
		Custom_click(exe.Exe_Dimensions(), " On Dimensions text");
		Wait(exe.Exe_Glamour_Dimensions_Image());
		VerifyImagePresent(exe.Exe_Glamour_Dimensions_Image(), " Dimensions Image- Glamour");
...
//	@Test(priority=3)
	public void TC_097_Glamour_Price() throws Exception {     //44 steps
...
//	@Test(priority=4)
	public void TC_098_Glamour_Compare() throws Exception {   
		...
		Wait(exe.Exe_Compare_Glamour_Bike1_Img());  
		VerifyImagePresent(exe.Exe_Compare_Glamour_Bike1_Img(), " image of first bike ");
		VerifyImagePresent(exe.Exe_Compare_Glamour_Bike2_Img(), " image of second bike ");
		ob.Compare2Bikes();
...
//	@Test(priority=5)
	public void TC_099_Glamour_Find_A_Dealer() throws Exception{  
	...
	@Test(priority=1)
	public void  TC_100_Glamour_RequestCallback() throws Exception {   
...
//	@Test(priority=7)
	public void TC_101_Glamour_Colours_360View() throws Exception {   // 44
		
		home.ReqCallBack();
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);",exe.colorSwitch_Glamour_SportsRed());
		...
		Thread.sleep(2000 );
		Wait(exe.colorSwitch_Glamour_SportsRed());
		VerifyImagePresent(exe.colorSwitch_Glamour_SportsRed(), "Sports Red Switch");
		Custom_click(exe.colorSwitch_Glamour_SportsRed(),"Sports Red Switch clickable");

		
		Wait(exe.colorSwitch_Glamour_MidnightBlack());
		VerifyImagePresent(exe.colorSwitch_Glamour_MidnightBlack(), "Midnight Black Switch");
		Custom_click(exe.colorSwitch_Glamour_MidnightBlack(),"Midnight Black Switch clickable");
		
		Wait(exe.colorSwitch_Glamour_RadiantRed());
		VerifyImagePresent(exe.colorSwitch_Glamour_RadiantRed(), "Radiant Red Switch");
		Custom_click(exe.colorSwitch_Glamour_RadiantRed(),"Radiant Red Switch clickable");
		
		Wait(exe.colorSwitch_Glamour_TechnoBlue());
		VerifyImagePresent(exe.colorSwitch_Glamour_TechnoBlue(), "Techno Blue Switch");
		Custom_click(exe.colorSwitch_Glamour_TechnoBlue(),"Techno Blue Switch clickable");
...
//	@Test(priority=8)
	public void TC_102_EXE_Glamour_Book_A_Test_Ride() throws Exception {  
...
//	@Test(priority=9)  //>>>need to check Explore now button if or not present
	public void TC_103_EXE_Glamour_EshopLinks() throws Exception {  
