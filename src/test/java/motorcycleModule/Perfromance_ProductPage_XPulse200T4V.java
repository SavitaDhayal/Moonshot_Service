...
public class Perfromance_ProductPage_XPulse200T4V extends base_class {
	...
	@Test(priority=0)
	public void Performance_productPage_Xpulse200T4V() throws Exception {
		...
		Custom_click(pfm.Xpulse200T4V_BikeName() , " on Xpulse200T4V Text ");
		Thread.sleep(2000);
		PageLoaded();
	}
	
	@Test(priority=1)
	public void TC_135_XPulse200TV_OverView() throws Exception {
...
//		VerifyElementPresent(home.get_connectMsg(),"Text Present ");
	...
	@Test(priority=2)
	public void TC_136_XPulse200TV_Specification() throws Exception {
		...
		String color1=pfm.Specs_SportsRed_Text().getText();
		Assert.assertEquals(color1, "Sports Red");
		
		Wait(pfm.Specs_FunkLimeYellow_Img());
		VerifyImagePresent(pfm.Specs_FunkLimeYellow_Img(), "Funk Lime Yellow Image");
		Custom_click(pfm.Specs_FunkLimeYellow_Img(), "Funk Lime Yellow Image clickable");
		VerifyElementPresent(pfm.Specs_FunkLimeYellow_Text()," Text present  : ");
		String color2=pfm.Specs_FunkLimeYellow_Text().getText();
		Assert.assertEquals(color2, "Funk Lime Yellow");
		
		Wait(pfm.Specs_MatteShieldGold_Img());
		VerifyImagePresent(pfm.Specs_MatteShieldGold_Img(), "Matte Shield Gold Image");
		Custom_click(pfm.Specs_MatteShieldGold_Img(), "Matte Shield Gold Image clickable");
		VerifyElementPresent(pfm.Specs_MatteShieldGold_Text()," Text present  : ");
		String color3=pfm.Specs_MatteShieldGold_Text().getText();
		Assert.assertEquals(color3, "Matte Shield Gold");

	}
	
	@Test(priority=3)
	public void TC_137_XPulse200TV_Features() throws Exception {
...
//		Custom_click(pfm.Xpulse2004V_BikeName() , " on Xpulse2004V Text ");
	...
	@Test(priority=4)
	public void TC_138_XPulse200TV_Price() throws Exception {
...
//		ob.check_Variant_and_priceText();
	...
	@Test(priority=5)
	public void TC_139_XPulse200TV_Find_A_Dealer() throws Exception {
	...
	@Test(priority=6)
	public void TC_140_XPulse200TV_Book_A_TestRide() throws Exception {
...
//		Thread.sleep(2000);
	...
	@Test(priority=7)
	public void TC_141_XPulse200TV_Eshoplinks() throws Exception {
		...
		Custom_click(pfm.Eshop_Accessories_Link(), "Accessories Sports");		
		change_window(1, " Next window");
		Thread.sleep(2000);
		GetCurrentUrl();
		PageLoaded();
